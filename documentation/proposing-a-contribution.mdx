...
![Which DARIAH-Campus Resource?](/assets/images/documentation/DC_Which_DARIAH-Campus_Resource.png)

Once you know what kind of contribution you’d like to make, you can click to the
appropriate instructions in the navigation SideNote in this section.
...
**Detailed description (&lt;300 words):** A description of the resource in fewer
than 300 words.
...
**Lead project / Lead institution:** The name of the project or lead institution
...
create/use the resource.

**Anticipated time of delivery:** An estimated time for the completion of the
resource to help with the planning process.
