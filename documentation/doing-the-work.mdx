...
![Copying the resource template folder](/assets/images/documentation/DC_HostRes_img1_copying.png)

**Copy** (do not ‘drag and drop’) the entire folder, and then **paste** it into
the ‘resources’ folder:

![Copying the resource template folder](/assets/images/documentation/DC_HostRes_img2_pasting.png)
...
![Copying the resource template folder](/assets/images/documentation/DC_HostRes_img3_green.png)
...
![Copying the resource template folder](/assets/images/documentation/DC_HostRes_img4_inBrowser.png)
...
![Copying the resource template folder](/assets/images/documentation/DC_PFndr_img1_copy.png)

**Copy** (do not ‘drag and drop’) the entire folder, and then **paste** it into
the ‘resources’ folder in your fork

![Copying the resource template folder](/assets/images/documentation/DC_PFndr_img2_paste.png)
...
![Copying the resource template folder](/assets/images/documentation/DC_PFndr_img3_index.png)
...
![Copying the resource template folder](/assets/images/documentation/DC_PFndr_img4_inBrowser.png)
...
![Copying the event template folder](/assets/images/documentation/DC_CapEvent_img1_copy.png)

**Copy** (do not ‘drag and drop’) the entire folder, and then **paste** it into
the ‘content/events’ folder in your fork.

![Copying the resource template folder](/assets/images/documentation/DC_CapEvent_img2_paste.png)

When you have these templates in your local ‘events’ fork, you can start
editing. You can see an example of the edited `index.mdx` file here:

![Copying the resource template folder](/assets/images/documentation/DC_CapEvent_img3_ingreen.png)
...
![Copying the event template folder](/assets/images/documentation/DC_CapEvent_img4_inBrowser.png)
...
![DARIAH-Campus Citation Fields](/assets/images/documentation/dariah-campus-citation-fields.jpeg)
...
the
[Sample-resource template](https://github.com/DARIAH-ERIC/dariah-campus/tree/master/templates)
