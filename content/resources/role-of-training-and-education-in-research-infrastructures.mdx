...
<Grid columns="2">
  ...
  <Youtube
    id="iwz0uhEhtg4"
    caption="Jennifer Edmond (DARIAH Director)"
  />

  <Youtube
    id="soL0itkLYpk"
    caption="Frank Fischer (DARIAH Director)"
  />

  <Youtube
    id="GIw3VHJwu5Y"
    caption="Agiatis Bernardou (Head of DARIAH VCC2)"
  />

  <Youtube
    id="ksxIewK316E"
    caption="Sinai Rusinek (Israel)"
  />

  <Youtube
    id="RnGyt4uymv8"
    caption="Maija Paavolainen (Finland)"
  />

  <Youtube
    id="mI1yfjAkwrM"
    caption="Claire Clivaz (Switzerland)"
  />

  <Youtube
    id="UPGetssiNL0"
    caption="Martin Lhoták (Czech Republic)"
  />
